...
var HTMLemail = '<li class="flex-item"><span class="green-text">email</span><span class="black-text">%data%</span></li>';
var HTMLtwitter = '<li class="flex-item"><span class="green-text">twitter</span><span class="black-text">%data%</span></li>';
var HTMLgithub = '<li class="flex-item"><span class="green-text">github</span><span class="black-text">%data%</span></li>';
